...
####### fit2 estimate among strain variance in response to diet
...
#purposes
setwd("C:/Users/Invunche/Dropbox/GitHub/Genetic_variation_TDT/Outputs")
sink("C:/Users/Invunche/Dropbox/GitHub/Genetic_variation_TDT/Outputs/2.1.1. Heritability_TDT_R_session.txt")
sessionInfo()
sink()
################################################################################
############################ END OF SCRIPT #####################################
