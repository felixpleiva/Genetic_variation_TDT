...
# This R script was created by Felix P. Leiva & Edwin J. Niklitschek
...
# check directory
setwd("/home/edwin/Insync/Edwin/PUBLICACIONES/Leiva et al (2024)")
# ------------------------------------------------------------------------------
#Libraries
library(car)
library(lme4)
...
females.ancova=cbind(females.est.ML,females.jk.ML)
#Hembras ML
